...
describe("Branch class test", () => {
  it("Test all methods", async () => {
    ...
    let branchItem1 = new BranchItem(btcInfo, new RskBlock(1, "hash", "prevHash", true, new ForkDetectionData(PREFIX + CPV + NU + "00000001")), 0);
    let branchItem2 = new BranchItem(btcInfo, new RskBlock(2, "hash", "prevHash", true, new ForkDetectionData(PREFIX + CPV + NU + "00000002")), 0);
    let branchItem3 = new BranchItem(btcInfo, new RskBlock(3, "hash", "prevHash", true, new ForkDetectionData(PREFIX + CPV + NU + "00000003")), 0);
    let branchItem4 = new BranchItem(btcInfo, new RskBlock(4, "hash", "prevHash", true, new ForkDetectionData(PREFIX + CPV + NU + "00000004")), 0);
    let branchItem5 = new BranchItem(btcInfo, new RskBlock(5, "hash", "prevHash", true, new ForkDetectionData(PREFIX + CPV + NU + "00000005")), 0);
    let branchItem6 = new BranchItem(btcInfo, new RskBlock(6, "hash", "prevHash", true, new ForkDetectionData(PREFIX + CPV + NU + "00000006")), 0);
    let branchItem7 = new BranchItem(btcInfo, new RskBlock(7, "hash", "prevHash", true, new ForkDetectionData(PREFIX + CPV + NU + "00000007")), 0);
    ...
    expect(branch.getCompleteBranch()).to.deep.equal([branchItem5,branchItem4,branchItem3].concat([new BranchItem(null, branchItem1.rskInfo, 0)]));
    ...
    expect(branch.getCompleteBranch()).to.deep.equal(forksItems.concat([new BranchItem(null, branchItem1.rskInfo, 0)]));
