...
describe("Fork class test", () => {
  it("Test all methods", async () => {
    ...
    let forkItem2 = new ForkItem(btcInfo1, new RskForkItemInfo(new ForkDetectionData(PREFIX + CPV + NU + "00000002"), 0), Date());
    let forkItem3 = new ForkItem(btcInfo2, new RskForkItemInfo(new ForkDetectionData(PREFIX + CPV + NU + "00000003"), 0), Date());
    let forkItem4 = new ForkItem(btcInfo3, new RskForkItemInfo(new ForkDetectionData(PREFIX + CPV + NU + "00000004"), 0), Date());
    let forkItem5 = new ForkItem(btcInfo4, new RskForkItemInfo(new ForkDetectionData(PREFIX + CPV + NU + "00000005"), 0), Date());
    let forkItem6 = new ForkItem(btcInfo5, new RskForkItemInfo(new ForkDetectionData(PREFIX + CPV + NU + "00000006"), 0), Date());
    let forkItem7 = new ForkItem(btcInfo6, new RskForkItemInfo(new ForkDetectionData(PREFIX + CPV + NU + "00000007"), 0), Date());
