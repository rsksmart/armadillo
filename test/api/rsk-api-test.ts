...
const NU = "00";
const blockAtHeight1 = new RskBlock(1, "", "", true, null);
...
describe("Rsk Service api tests, getRangeForkWhenItCouldHaveStarted method", () => {
  ...
  describe("Far future case:", () => {
    it("Far Future case. CPV match 0 bytes. fork range should go from 1 to best block", async () => {
      const newRskBlock = new RskBlock(1000, "", "", true, new ForkDetectionData(PREFIX + "d89d8bf4d2e434" + NU + "000003E8"));
      const bestBlock = new RskBlock(500, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "000001F4"));
      ...
      let rangeReturn: RangeForkInMainchain = await rskApiService.getRangeForkWhenItCouldHaveStarted(newRskBlock, bestBlock);
  ...
  describe("Near future case:", () => {
    it("CPV match 7 bytes.", async () => {
      const newRskBlock = new RskBlock(1005, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "000003ED"));
      const bestBlock = new RskBlock(1000, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "000003E8"));
      let block960 = new RskBlock(960, "", "", true, null);
    ...
    it("CPV match 6 bytes.", async () => {
      const newRskBlock = new RskBlock(1005, "", "", true, new ForkDetectionData(PREFIX + "665544332211AA" + NU + "000003ED"));
      const bestBlock = new RskBlock(1000, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "000003E8"));
      let block896 = new RskBlock(896, "", "", true, null);
      let block960 = new RskBlock(960, "", "", true, null);
    ...
    it("CPV match 5 bytes.", async () => {
      const newRskBlock = new RskBlock(1005, "", "", true, new ForkDetectionData(PREFIX + "5544332211AABB" + NU + "000003ED"));
      const bestBlock = new RskBlock(1000, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "000003E8"));
      let block832 = new RskBlock(832, "", "", true, null);
      let block896 = new RskBlock(896, "", "", true, null);
    ...
    it("CPV match 4 bytes.", async () => {
      const newRskBlock = new RskBlock(1005, "", "", true, new ForkDetectionData(PREFIX + "44332211AABBCC" + NU + "000003ED"));
      const bestBlock = new RskBlock(1000, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "000003E8"));
      let block832 = new RskBlock(832, "", "", true, null);
      let block768 = new RskBlock(768, "", "", true, null);
    ...
    it("CPV match 3 bytes.", async () => {
      const newRskBlock = new RskBlock(1005, "", "", true, new ForkDetectionData(PREFIX + "332211AABBCCDD" + NU + "000003ED"));
      const bestBlock = new RskBlock(1000, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "000003E8"));
      let block704 = new RskBlock(704, "", "", true, null);
      let block768 = new RskBlock(768, "", "", true, null);
    ...
    it("CPV match 2 bytes.", async () => {
      const newRskBlock = new RskBlock(1005, "", "", true, new ForkDetectionData(PREFIX + "2211AABBCCDDEE" + NU + "000003ED"));
      const bestBlock = new RskBlock(1000, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "000003E8"));
      let block704 = new RskBlock(704, "", "", true, null);
      let block640 = new RskBlock(640, "", "", true, null);
    ...
    it("CPV match 1 bytes.", async () => {
      const newRskBlock = new RskBlock(1005, "", "", true, new ForkDetectionData(PREFIX + "11AABBCCDDEEFF" + NU + "000003ED"));
      const bestBlock = new RskBlock(1000, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "000003E8"));
      let block576 = new RskBlock(576, "", "", true, null);
      let block640 = new RskBlock(640, "", "", true, null);
    ...
    it("CPV match 0 bytes.", async () => {
      const newRskBlock = new RskBlock(1005, "", "", true, new ForkDetectionData(PREFIX + "AABBCCDDEEFF99" + NU + "000003ED"));
      const bestBlock = new RskBlock(1000, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "000003E8"));
      let block576 = new RskBlock(576, "", "", true, null);
  ...
  describe("Past cases (far/near it's pritty the same):", () => {
    it("CPV match 7 bytes.", async () => {
      const newRskBlock = new RskBlock(5000, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "00001388"));
      const blockSameHeight = new RskBlock(5000, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "00002710"));
      let block5056 = new RskBlock(5056, "", "", true, null);
      let block4992 = new RskBlock(4992, "", "", true, null);
      ...
      let rangeReturn: RangeForkInMainchain = await rskApiService.getRangeForkWhenItCouldHaveStarted(newRskBlock, blockSameHeight);
    ...
    it("CPV match 6 bytes.", async () => {
      const newRskBlock = new RskBlock(5000, "", "", true, new ForkDetectionData(PREFIX + "665544332211AA" + NU + "00001388"));
      const blockSameHeight = new RskBlock(5000, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "00002710"));
      let block4928 = new RskBlock(4928, "", "", true, null);
      let block4992 = new RskBlock(4992, "", "", true, null);
    ...
    it("CPV match 5 bytes.", async () => {
      const newRskBlock = new RskBlock(5000, "", "", true, new ForkDetectionData(PREFIX + "5544332211AABB" + NU + "00001388"));
      const blockSameHeight = new RskBlock(5000, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "00002710"));
      let block4928 = new RskBlock(4928, "", "", true, null);
      let block4864 = new RskBlock(4864, "", "", true, null);
    ...
    it("CPV match 4 bytes.", async () => {
      const newRskBlock = new RskBlock(5000, "", "", true, new ForkDetectionData(PREFIX + "44332211AABBCC" + NU + "00001388"));
      const blockSameHeight = new RskBlock(5000, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "00002710"));
      let block4800 = new RskBlock(4800, "", "", true, null);
      let block4864 = new RskBlock(4864, "", "", true, null);
    ...
    it("CPV match 3 bytes.", async () => {
      const newRskBlock = new RskBlock(5000, "", "", true, new ForkDetectionData(PREFIX + "332211AABBCCDD" + NU + "00001388"));
      const blockSameHeight = new RskBlock(5000, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "00002710"));
      let block4800 = new RskBlock(4800, "", "", true, null);
      let block4736 = new RskBlock(4736, "", "", true, null);
    ...
    it("CPV match 2 bytes.", async () => {
      const newRskBlock = new RskBlock(5000, "", "", true, new ForkDetectionData(PREFIX + "2211AABBCCDDEE" + NU + "00001388"));
      const blockSameHeight = new RskBlock(5000, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "00002710"));
      let block4736 = new RskBlock(4736, "", "", true, null);
      let block4672 = new RskBlock(4672, "", "", true, null);
    ...
    it("CPV match 1 bytes.", async () => {
      const newRskBlock = new RskBlock(5000, "", "", true, new ForkDetectionData(PREFIX + "11AABBCCDDEEFF" + NU + "00001388"));
      const blockSameHeight = new RskBlock(5000, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "00002710"));
      let block4608 = new RskBlock(4608, "", "", true, null);
      let block4672 = new RskBlock(4672, "", "", true, null);
    ...
    it("CPV match 0 bytes.", async () => {
      const newRskBlock = new RskBlock(5000, "", "", true, new ForkDetectionData(PREFIX + "AABBCCDDEEFF99" + NU + "00001388"));
      const blockSameHeight = new RskBlock(5000, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "00002710"));
      let block4608 = new RskBlock(4608, "", "", true, null);
  ...
  describe("Present case, cpv is near to change :", () => {
    it("CPV match 7 bytes.", async () => {
      const newRskBlock = new RskBlock(4992, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "00001388"));
      const blockSameHeight = new RskBlock(4992, "", "", true, new ForkDetectionData(PREFIX + "77665544332211" + NU + "00001380"));
      let block4928 = new RskBlock(4928, "", "", true, null);
