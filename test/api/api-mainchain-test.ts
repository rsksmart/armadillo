...
describe("Mainchain api tests", () => {
  ...
  it("save method and getLastBlocks method", async () => {
    ...
    let item = new Item(btcInfo, new RskBlock(1, "hash", "prevHash", true, new ForkDetectionData(RSKTAG)));
    ...
    let item2 = new Item(btcInfo, new RskBlock(2, "hash", "prevHash", true, new ForkDetectionData(PREFIX + CPV + NU + "00000002")));
    let item3 = new Item(btcInfo, new RskBlock(3, "hash", "prevHash", true, new ForkDetectionData(PREFIX + CPV + NU + "00000003")));
    let item4 = new Item(btcInfo, new RskBlock(4, "hash", "prevHash", true, new ForkDetectionData(PREFIX + CPV + NU + "00000004")));
    let item5 = new Item(btcInfo, new RskBlock(5, "hash", "prevHash", true, new ForkDetectionData(PREFIX + CPV + NU + "00000005")));
  ...
  it("getBlockByForkDataDetection method", async () => {
    ...
    let item1 = new Item(btcInfo, new RskBlock(1, "hash", "prevHash", true, forkDetectionData));
  ...
  it("updateBtcInfoItem method", async () => {
    ...
    var forkDetectionData = new ForkDetectionData(PREFIX + CPV + NU + "00000001");
    let item1 = new Item(null, new RskBlock(1, "hash", "prevHash", true, forkDetectionData));
  ...
  it("getBlock method", async () => {
    ...
    let item1 = new Item(null, new RskBlock(1, "hash", "prevHash", true, forkDetectionData));
    let itemUncle = new Item(null, new RskBlock(1, "otroHash", "otroPrevHash", false, forkDetectionData));
  ...
  it("changeBlockInMainchain method", async () => {
    let item1 = new Item(null, new RskBlock(1, "hash", "prevHash", true, new ForkDetectionData(PREFIX + CPV + NU + "00000001")));
    let item2 = new Item(null, new RskBlock(2, "hash", "prevHash", true,  new ForkDetectionData(PREFIX + CPV + NU + "00000002")));
    let item3 = new Item(null, new RskBlock(3, "hash", "prevHash", true, new ForkDetectionData(PREFIX + CPV + NU + "00000003")));
    let itemToChange = new Item(null, new RskBlock(1, "otroHash", "otroPrevHash", true, new ForkDetectionData(PREFIX + CPV + NU + "00000001")));
  ...
  it("getLastBtcBlocksDetectedInChain method", async () => {
    ...
    let item1WithBTC = new Item(new BtcHeaderInfo(1000, ""), new RskBlock(100, "hash", "prevHash", true, new ForkDetectionData(RSKTAG)));
    ...
    for(var i = 101; i <= 120; i++){
      itemsToSave.push(new Item(null, new RskBlock(i, "hash" + i, "prevHash" + (i-1), true, new ForkDetectionData(RSKTAG))));
    }
    let item2WithBTC = new Item(new BtcHeaderInfo(1120, ""), new RskBlock(121, "hash121", "prevHash120", true, new ForkDetectionData(RSKTAG)));
    ...
    let item3WithBTC = new Item(new BtcHeaderInfo(1122, ""), new RskBlock(131, "hash121", "prevHash120", true, new ForkDetectionData(RSKTAG)));
    ...
    let item4WithBTC = new Item(new BtcHeaderInfo(1125, ""), new RskBlock(140, "hash140", "prevHash139", false, new ForkDetectionData(RSKTAG)));
