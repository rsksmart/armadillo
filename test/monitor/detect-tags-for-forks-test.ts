...
const btcBlock2 = new BtcBlock(101, "btcHash101", RSKTAG1);
const btcBlock3 = new BtcBlock(102, "btcHash102", RSKTAG1);
const btcBlock4 = new BtcBlock(103, "btcHash103", RSKTAG1);
