...
export const context = {
    headers: ['Content-Type: application/json', `Host: ${host}`, 'Accept: */*'],
    httpversion: '	1.1',
};
...
const mapRskNoMatchNoMatchCPV4B = {
    '40': 1028,
};
...
const mapRskNoMatchNoMatchCPV7B2 = {
    '53': 2493,
};
...
export function rskBlockHeightsWithBtcBlock() {
    return {
        ...
        ...mapRskNoMatchNoMatchCPV4B,
        ...mapRskNoMatchNoMatchCPV7B,
        ...mapRskNoMatchNoMatchCPV7B2,
    };
}
