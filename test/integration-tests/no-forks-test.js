...
describe("Tests for mainchain only BTC RSK interaction, no forks", () => {
    it.only("should not generate any mainchain if BTC doesn't present RSK tags", async () => {
    ...
    it.skip("should generate a mainchain connection between 2 consecutive BTC blocks with RSK tags", async () => {
        let step = 1;
        await utils.MockBtcApiChangeRoute("raw");
    ...
    it.skip("should generate a mainchain connection among 3 consecutive BTC blocks with RSK", () => {
        let step = 1;
        await utils.MockBtcApiChangeRoute("raw");
        await utils.setHightInMockBTCApi(954);
        await utils.DeleteCollection(db, mainchain);
    ...
    it.skip("should generate a mainchain connection between 2 BTC blocks with RSK tags, separated by 3 without RSK tags", () => {
        let step = 1;
        await utils.MockBtcApiChangeRoute("raw");
